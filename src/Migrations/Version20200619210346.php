 ...
 */
final class Version20200619210346 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE provider_hotel_prix CHANGE providerhotels_id providerhotels_id INT DEFAULT NULL, CHANGE provider_hotel_id provider_hotel_id INT DEFAULT NULL');
