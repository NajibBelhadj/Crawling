 ...
 */
final class Version20200528205420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE provider_hotel DROP hotel_ref, DROP ville');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE provider_hotel ADD hotel_ref TINYINT(1) DEFAULT \'NULL\', ADD ville VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE provider_hotel_img CHANGE providerhotels_id providerhotels_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE provider_hotel_prix CHANGE providerhotels_id providerhotels_id INT DEFAULT NULL');
