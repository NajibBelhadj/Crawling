 ...
 */
final class Version20200315171014 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD plainpassword VARCHAR(255) NOT NULL, CHANGE roles roles JSON NOT NULL');
    }
